...
export const projectCommand: Command = { name: "/project", usage: "/project <name|number>", description: "Open a project by its name, a partial name, or its number in /projects", execute: (args) => {
